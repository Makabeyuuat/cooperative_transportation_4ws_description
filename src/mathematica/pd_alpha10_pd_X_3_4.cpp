...
{
double ret;
ret = ((1 - sr.Cs*sr.d)*Sec(x_old[18])*Sec(Thetap0)*(2*Cos(x_old[18] - Thetap0 + Thetap8)*Sec(x_old[4])*Sin(PAI/6. + Thetap0 - Thetap1)*Sin(x_old[4] - Thetap0 + Thetap1) - 2*Cos(x_old[18] - Thetap0 + Thetap8)*Power(Sec(x_old[4]),3)*Sin(PAI/6. + Thetap0 - Thetap1)*Sin(x_old[4] - Thetap0 + Thetap1) - 4*Cos(x_old[4] - Thetap0 + Thetap1)*Cos(x_old[18] - Thetap0 + Thetap8)*Sec(x_old[4])*Sin(PAI/6. + Thetap0 - Thetap1)*Tan(x_old[4]) - 2*Cos(x_old[18] - Thetap0 + Thetap8)*Sec(x_old[4])*Sin(PAI/6. + Thetap0 - Thetap1)*Sin(x_old[4] - Thetap0 + Thetap1)*Power(Tan(x_old[4]),2) - Sin(x_old[18] - Thetap0 + Thetap8)*(-2*Cos(PAI/6. + Thetap0 - Thetap1)*Sec(x_old[4])*Sin(x_old[4] - Thetap0 + Thetap1) + 2*Cos(PAI/6. + Thetap0 - Thetap1)*Power(Sec(x_old[4]),3)*Sin(x_old[4] - Thetap0 + Thetap1) + 4*Cos(PAI/6. + Thetap0 - Thetap1)*Cos(x_old[4] - Thetap0 + Thetap1)*Sec(x_old[4])*Tan(x_old[4]) + 2*Cos(PAI/6. + Thetap0 - Thetap1)*Sec(x_old[4])*Sin(x_old[4] - Thetap0 + Thetap1)*Power(Tan(x_old[4]),2))))/l2;
return ret;
}
