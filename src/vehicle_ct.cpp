...
void Vehicle::publishSteeringCommand(double front_left_steering_value, double front_right_steering_value, double rear_left_steering_value, double rear_right_steering_value) {
